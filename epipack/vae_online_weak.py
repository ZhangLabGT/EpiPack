...
from loss import mse_loss, bce_loss, maximum_mean_discrepancy_transfer, NB, ZINB 
...
class VAE_MAPPING(nn.Module):
    ...
    def loss(self, dict_inf = None, count= None, rec= None, ref_z = None, batch_id = None, count_eh = None, lib_size = 1, rec_type = 'MSE', ref_weight=None, query_weight = None, ref_bias=None, query_bias=None):
        '''
        Loss #1 + #2 = ELBO
        ...
        loss_mmd = maximum_mean_discrepancy_transfer(xs, batch_ids=batch_ids, device=self.device_use)
